...
import adminCheckEmployeePresenceByEmployeeIdRoute from "./src/admin/employee/routes/adminCheckEmployeePresenceByEmployeeIdRoute.js";
...
import hrSearchEmployeesRoute from "./src/hr/employee/routes/hrSearchEmployeesRoute.js";
...
import hrCheckEmployeePresenceByEmployeeIdRoute from "./src/hr/employee/routes/hrCheckEmployeePresenceByEmployeeIdRoute.js";
...
import hrEditLeavePaymentStatusesRoute from "./src/hr/leave/routes/hrEditLeavePaymentStatusesRoute.js";
...
import hrCreateProjectRoute from "./src/hr/projects/routes/hrCreateProjectRoute.js";
import hrEditProjectRoute from "./src/hr/projects/routes/hrEditProjectRoute.js";
import hrGetAllProjectsRoute from "./src/hr/projects/routes/hrGetAllProjectsRoute.js";
import hrGetProjectByIdRoute from "./src/hr/projects/routes/hrGetProjectByIdRoute.js";
import hrGetProjectMembersByProjectIdRoute from "./src/hr/projects/routes/hrGetProjectMembersByProjectIdRoute.js";
...
import employeeGetProfilePictureRoute from "./src/employee/profile/routes/employeeGetProfilePictureRoute.js";
...
await app.register(hrSearchEmployeesRoute);
...
await app.register(hrEditAShiftRoute);
...
await app.register(hrGetEmployeeDayPunchesRoute);
...
await app.register(hrEditLeavePaymentStatusesRoute);
...
await app.register(hrCreateProjectRoute);
await app.register(hrEditProjectRoute);
await app.register(hrGetAllProjectsRoute);
await app.register(hrGetProjectByIdRoute);
await app.register(hrGetProjectMembersByProjectIdRoute);
...
await app.register(employeeGetDayPunchesRoute);
await app.register(employeeMakeOrRefreshAttendanceRoute);
await app.register(employeeGenerateAndSendMonthlyReportsRoute);
